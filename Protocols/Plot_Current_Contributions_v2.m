function Plot_Current_Contributions_v2(CVsol)
    ...
    e = -CVsol.par.e;
    loss_currents = df_analysis.calcr(CVsol, 'sub');
    x = CVsol.par.x_sub;
    gxt = df_analysis.calcg(CVsol);
    J = df_analysis.calcJ(CVsol);
    j_surf_rec = df_analysis.calcj_surf_rec(CVsol);
