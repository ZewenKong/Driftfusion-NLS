...
% - parad. >> N/A
% -
[t_J_max, t_J_corr] = dfana_ionic.tPntOfSpJs(sol, 0); % dfana_ionic.m
%
%% - - - - - - - - - - energy level diagram at special time point
% -
dfplot.ELx(sol, [t_J_max, t_J_corr]);
% dfplot.ELx(sol, t_J_corr);

%dfplot.ELxnpxacx(sol, t_J_max);
%dfplot.ELxnpxacx(sol, t_J_corr);
%
%% - - - - - - - - - -
% -
...
%% -
dfplot.ELx(sol_2); % energy level plot
%% -
